# data-pipeline / azure adapter

**This is a private adapter of the `data-pipeline` bounded context. Do not source it
directly.**

It translates the `data-pipeline` contract into azure resources, and its interface
...
Consume [`domains/data-pipeline`](../) instead. `scripts/check-boundaries.sh` fails CI
