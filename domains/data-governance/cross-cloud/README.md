# data-governance / cross-cloud adapter

**This is a private adapter of the `data-governance` bounded context. Do not source it
directly.**

It translates the `data-governance` contract into cross-cloud resources, and its interface
...
Consume [`domains/data-governance`](../) instead. `scripts/check-boundaries.sh` fails CI
