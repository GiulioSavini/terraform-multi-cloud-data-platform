# networking / azure adapter

**This is a private adapter of the `networking` bounded context. Do not source it
directly.**

It translates the `networking` contract into azure resources, and its interface
...
Consume [`domains/networking`](../) instead. `scripts/check-boundaries.sh` fails CI
